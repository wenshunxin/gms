...
$(function(){
	 ...
	 $("#investigateDate").val(new Date().toLocaleDateString());
...
<body style="overflow: hidden; font-size: 12px; padding: 20px 0;" onload="getIndicatorsRecordsById()">
	<form id="form1" name="form1" method="post"
		...
		<table class='TableBlock' style='width: 95%; margin: 0 auto;'>
			...
			<tr>
				...
				<input type="text" class='BigInput easyui-combobox' id='monitoringStationsId' name='monitoringStationsId' style="height:28px;line-height: 28px;"/></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td class='TableData' ><input type="text" class="BigInput" id='investigateUserNames' name='investigateUserNames' maxlength="20"/> </td>
			...
			<tr>
				...
				<td class='TableData'><input type="text" class='BigInput easyui-combobox'  id='indicatorsId' name='indicatorsId' style="height:28px;line-height: 28px;"/> </td>
				<td class='TableData'>指标值：</td>
				<td class='TableData'>
					<input type="text" class="BigInput easyui-validatebox" id='indicatorsValue' name='indicatorsValue' validType="number[] &addMethodf[]" required="true"/> 
				</td>
			</tr>
		</table>
