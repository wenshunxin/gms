...
function doInit(){
	statistics(4);
	var url = contextPath+"/gmsInvestigateDataController/queryDataList.act?investigateType=4";
	datagrid = $('#datagrid').datagrid({
		...
		columns:[[
			...
			[
				...
				{field:'4',title:'修改',width:20,align:"center",formatter:function(e,rowData,index){
					...
					var html ="<div class='sampleArea'>"
							+"<a class='editCtrl' href='javascript:void(0);' title='修改' onclick=\"editEcological("+rowData.sampleAreaId+",'"+auditContent+"')\"></a>"
							+"</div>";
					return html;
				}},
				{field:'5',title:'删除',width:20,align:"center",formatter:function(e,rowData,index){
					var html ="<div class='sampleArea'><a class='deleteCtrl' title='删除' href='javascript:void(0);' onclick='deleteEcological("+rowData.sampleAreaId+")'></a>"
							+"</div>";
					return html;
				}},
				{field:'6',title:'详情',width:20,align:"center",formatter:function(e,rowData,index){
					...
					var html ="<div class='sampleArea'>"
							...
							+"onclick=\"detail("+rowData.dataId+","+rowData.inOrOut+","+rowData.sampleAreaId+",'"+rowData.investigateNum+"',"+rowData.investigateType+",'"+auditContent+"')\"></a>"
							+"</div>";
					return html;
				}}
			]]
		/* 	,
			onLoadSuccess:function(){
				 ...
				 var rows1 = s.find('tr.datagrid-row td[field!=dataId]');
...
<body onload="doInit();" style="overflow: hidden; font-size: 12px">
	...
	<div id="toolbar">
		<div class="moduleHeader" style='height: 60px; padding-top: 20px;'>
			<img src='<%=contextPath%>/resource/images/sys/home.png' style='top:20px;'/><b class="first">当前位置：常规监测报送》<b class="second">生态环境调查</b></b>
			<div style="float: right;">
				<input type="button" class="btn btn-success" style="background: #42a576;" value="添加生态环境调查"
					onclick="addEcological()" /> <input type="button"
					class="btn btn-success" style="background: #42a576;" value="批量上报" onclick="mulitiSubmit(4)" />
			</div>
