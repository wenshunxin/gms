...
function doInit(){
	statistics(7);
	var url = contextPath+"/gmsInvestigateDataController/queryDataList.act?investigateType=7";
	datagrid = $('#datagrid').datagrid({
		...
		columns:[[
			...
			{field:'investigateNum',title:'数据名称',width:250,rowspan:2,formatter:function(e,rowData,index){
				return "<div class='sampleArea sampleAreaWeight'>"+rowData.year+"-"+rowData.investigateNum+"月长势</div>";
			}},
			...
			{title:'操作',colspan:4,align:"center"}
			],
			[
				...
				{field:'4',title:'修改',width:20,align:"center",formatter:function(e,rowData,index){
					...
					var html ="<div class='sampleArea'>"
							+"<a class='editCtrl' href='javascript:void(0);' title='修改' onclick=\"editVegetationGrew("+rowData.sampleAreaId+",'"+auditContent+"')\"></a>"
							+"</div>";
					return html;
				}},
				{field:'5',title:'删除',width:20,align:"center",formatter:function(e,rowData,index){
					var html ="<div class='sampleArea'><a class='deleteCtrl' title='删除' href='javascript:void(0);' onclick='deleteVegetationGrew("+rowData.sampleAreaId+")'></a>"
							+"</div>";
					return html;
				}},
...
<body onload="doInit();" style="overflow: hidden; font-size: 12px">
	...
	<div id="toolbar">
		<div class="moduleHeader" style='height: 60px; padding-top: 20px;'>
			<img src='<%=contextPath%>/resource/images/sys/home.png' style='top:20px;'/><b class="first">当前位置：常规监测报送》<b class="second">植被长势调查</b></b>
			<div style="float: right;">
				<input type="button" class="btn btn-success" style="background: #41a675;" value="添加植被长势调查"
					onclick="addVegetationGrew(7)" /> <input type="button"
					class="btn btn-success" style="background: #41a675;" value="批量上报" onclick="mulitiSubmit(7)" />
			</div>
