...
<form id="form1" name="form1" method="post">
	<table class="TableBlock" width="100%" style="margin:0 auto;border-left: 0;border-right:0;">
		...
		<tr>
			...
			<td class="TableData">
				<input type="text" id='freshAmount' name='freshAmount' class='SmallInput easyui-validatebox' validType="integeZerol[]"/>(千克/公顷)
			</td>
		</tr>
		<tr>
			<td class="TableData">总产草量风干重：</td>
			<td class="TableData">
				<input type="text" id='dryAmount' name='dryAmount' class='SmallInput easyui-validatebox' validType="integeZerol[]"/>(千克/公顷)
			</td>
			<td class="TableData">可食产草量鲜重：</td>
			<td class="TableData">
				<input type="text" id='edibleFreshAmount' name='edibleFreshAmount' class='SmallInput easyui-validatebox' validType="integeZerol[]"/>(千克/公顷)
			</td>
			<td class="TableData">可食产草量风干重：</td>
			<td class="TableData">
				<input type="text" id='edibleDryAmount' name='edibleDryAmount' class='SmallInput easyui-validatebox' validType='integeZerol[]'/>(千克/公顷)
			</td>
		</tr>
		<tr>
