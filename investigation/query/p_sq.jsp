...
<form id="form1" name="form1" method="post">
	<table class="TableBlock" width="100%" style="margin:0 auto;border-left:0;border-right:0;">
		<tr>
			...
			<td class="TableData">
				<input type="text" id='herbMainPlant' name='herbMainPlant' class='BigInput easyui-validatebox' />
			</td>
		</tr>
		<tr>
		...
		<tr>
			<td class="TableData">灌木和高大草本名称：</td>
			<td class="TableData">
				<input type="text" id='shrubsMainPlant' name='shrubsMainPlant' class='BigInput easyui-validatebox' />
			</td>
