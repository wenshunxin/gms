...
<form id="form1" name="form1" method="post" >
	<table class="TableBlock" width="100%" style="margin:0 auto;border-left:0;border-right:0;">
		...
		<tr>
			...
			<td class="TableData">
				<input type='text' id='averageAnnualRainfall' name='averageAnnualRainfall' class='SmallInput easyui-validatebox' validType='integeZerol[] & addMethodf[]'/>(毫米)
			</td>
		</tr>
		<tr>
			<td class="TableData">利用方式：</td>
			<td class="TableData">
				<select id="usingType" name="usingType" class="BigSelect" style="width:78px;">
					<option value="">全部</option>
			...
			<td class="TableData">
				<select id="usingStatus" name="usingStatus" class="BigSelect" style="width:78px;">
					<option value="">全部</option>
