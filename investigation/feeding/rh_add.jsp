...
<style>
	i{color:red;font-weight: bold;font-size: 16px;}
</style>
</head>
<script>
var id = '<%=id%>';
	...
	if($("#form1").form("validate")){
		...
		if(json.rtState){
			if(id!="null" && id!=null){
				...
				top.$("#tabs").tabs("getSelected").find('iframe')[0].contentWindow.statistics(3);
				...
				var submit = function (v, h, f) {
				    if(v==2){
				    	that.$("#tabs").tabs("getSelected").find('iframe')[0].contentWindow.addFeeding(3);
				    	 return true;
				    }else{
				    	return true;
				    }
				...
				// 自定义按钮
				that.$.jBox.confirm("保存成功", "提示", submit, { buttons: {"继续添加入户补饲调查": 2,'关闭':3} });
			 }
		}else{
		...
		<table class='TableBlock' style='width: 90%; margin: 0 auto;'>
			...
			<tr>
				...
				<td class='TableData' colspan='3'>
						...
						乡镇：<input id='countyName' name='countyName' class='BigInput easyui-validatebox' validType='' maxlength="20" /><i>*</i>
			...
			<tr>
				...
				<td class='TableData' colspan="3"><input type="text"
					id='householdUserName' name='householdUserName'
			...
			<tr>
				...
				<td class='TableData'><input type="text" id='sheepAmount'
					name='sheepAmount' class='SmallInput easyui-validatebox' validType="integeZero[]" /><span class="wan">(只)</span></td>
			</tr>
			<tr>
				...
				<td class='TableData'><input type="text" id='goatAmount'
					name='goatAmount' class='SmallInput easyui-validatebox'  validType="integeZero[]"/><span class="wan">(只)</span></td>
			</tr>
			<tr>
				<td class='TableData'>人工草地产草总量：</td>
				<td class='TableData'><input type="text"
					id='artificialGrassAmount' name='artificialGrassAmount'
					class='SmallInput easyui-validatebox' validType="integeZerol[] & addMethodf[]"/><span class="dun">(公斤)</span></td>
				<td class='TableData'>牛数量：</td>
				<td class='TableData'><input type="text" id='cowAmount'
					name='cowAmount' class='SmallInput easyui-validatebox' validType="integeZero[]"/><span class="tou">(头)</span></td>
			</tr>
			<tr>
				<td class='TableData'>补饲秸秆等总量：</td>
				<td class='TableData'><input type="text" id='strawAmount'
					name='strawAmount' class='SmallInput easyui-validatebox' validType="integeZerol[] & addMethodf[]"/><span class="dun">(公斤)</span></td>
				<td class='TableData'>马数量：</td>
				<td class='TableData'><input type="text" id='horseAmount'
					name='horseAmount' class='SmallInput easyui-validatebox' validType="integeZero[]"/><span class="pi">(匹)</span></td>
			</tr>
			<tr>
				<td class='TableData'>青贮饲料总量：</td>
				<td class='TableData'><input type="text" id='silageAmount'
					name='silageAmount' class='SmallInput easyui-validatebox' validType="integeZerol[] & addMethodf[]"/><span class="dun">(公斤)</span></td>
				<td class='TableData'>骆驼数量：</td>
				<td class='TableData'><input type="text" id='camelAmount'
					name='camelAmount' class='SmallInput easyui-validatebox' validType="integeZero[]"/><span class="tou">(峰)</span></td>
			</tr>
			<tr>
				<td class='TableData'>粮食补饲量：</td>
				<td class='TableData'><input type="text" id='foodAmount'
					name='foodAmount' class='SmallInput easyui-validatebox' validType="integeZerol[] & addMethodf[]"/><span class="dun">(公斤)</span></td>
				<td class='TableData'>骡数量：</td>
				<td class='TableData'><input type="text" id='muleAmount'
					name='muleAmount' class='SmallInput easyui-validatebox' validType="integeZero[]"/><span class="tou">(头)</span></td>
			</tr>
			<tr>
				...
				<td class='TableData'><input type="text" id='donkeyAmount'
					name='donkeyAmount' class='SmallInput easyui-validatebox' validType="integeZero[]"/><span class="tou">(头)</span></td>
			</tr>
			<tr>
				...
				<td class='TableData'><input type="text"
					...
					class='SmallInput easyui-validatebox' validType="integeZero[]"/><span class="wanT">(头/只)</span></td>
			</tr>
		</table>
