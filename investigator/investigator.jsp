...
<body style="overflow-xs: hidden; font-size: 12px; padding: 20px 0;"
	...
	<form id="form1" name="form1" method="post">
		<table class='TableBlock' style='width: 90%; margin: 0 auto;'>
			...
			<tr>
				<td class='TableData'>调查人姓名：</td>
				<td class='TableData'><input type="text" id='investigatorName'
					name='investigatorName' autocomplete="off"
					class='easyui-validatebox BigInput' required="true" maxlength="20" validType="isBlank[]"/><i>*</i></td>
			</tr>
			<tr>
				<td class='TableData'>民族：</td>
				<td class='TableData'>
				<input type="text" id='investigatorNational' class="BigInput easyui-validatebox" name='investigatorNational' required="true" validType="isBlank[]"/><i>*</i></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td class='TableData'><input type="text" id="investigatorPhone"
					...
					required="true" validType='mobile[]' required="true" maxlength="11" /><i>*</i></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td class='TableData'><input type="text" id="investigatorEmail"
					...
					required="true" validType="email[]" required="true" /><i>*</i></td>
			</tr>
		</table>
